...
class OfficeDocumentStyles(XMLMixin):
    ...
    def _setup(self):
        ...
        self.main_styles = wrap(subelement(self.xmlnode, CN('office:main-styles')))
...
@register_class
class OfficeMainStyles(Container):
    TAG = CN('office:main-styles')
...
class Style(BaseStyle):
    ...
    ATTRIBUTEMAP = {
        ...
        'main-page-name': CN('style:main-page-name'),
